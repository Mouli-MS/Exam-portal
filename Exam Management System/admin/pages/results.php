        ...
        <div class="main">
            <div class="content">
                <div class="report">
                    ...
                    <!-- Add the button for exporting data to Excel -->
                    <a href="<?php echo SITEURL; ?>admin/pages/export_all.php">
                        <button type="button" class="btn-export">Export All to PDF</button>
                    </a>
                </div>
            </div>
        </div>
