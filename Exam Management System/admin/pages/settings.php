            ...
            <div class="content">
                <div class="report">
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                           ...
                           $current_password = hash('sha256', $obj->sanitize($conn, $_POST['current_password']));
                ...
                <div class="report">
                    ...
                    <form method="post" action="" class="forms">
                        ...
                        <input type="password" name="confirm_password" placeholder="Confirm Password" required="true" /><br /><br>
                    ...
                    <?php 
                        if(isset($_POST['update']))
                        {
                            ...
                            $new_password = hash('sha256', $obj->sanitize($conn, $_POST['new_password']));
                            $confirm_password = hash('sha256', $obj->sanitize($conn, $_POST['confirm_password']));
                            $current_password = hash('sha256', $obj->sanitize($conn, $_POST['current_password']));
